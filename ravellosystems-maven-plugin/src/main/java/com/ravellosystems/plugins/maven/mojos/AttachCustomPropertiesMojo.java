...
@Mojo(name = "attach-custom-props", defaultPhase = LifecyclePhase.PACKAGE, threadSafe = true, aggregator = true)
public class AttachCustomPropertiesMojo extends ApplicationMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        try {
            File zip = createZip(new File(propertiesFile));
            attach(zip, -1);
